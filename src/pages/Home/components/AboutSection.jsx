...
export default function AboutSection() {
    return (
        <div className="bg-[rgba(248,248,248,1)]">
            <div className="container mx-auto px-12 py-8  grid grid-cols-1 lg:grid-cols-2 gap-[-10px] place-items-center my-20">
                <img src={aboutpic} alt="clothespic" className="w-[400px] h-[400px]" />
                <div className="h-80 w-[400px]" dir="rtl">
